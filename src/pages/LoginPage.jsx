      ...
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300">
        <div className="bg-white rounded-3xl shadow-lg p-10 w-[400px] text-center space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-[#3E36B0] text-white font-semibold py-2 rounded-lg shadow hover:bg-indigo-700 transition-all"
          >
            <FaUserMd />
            Doctor
          </button>
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 px-4">
      <div className="bg-white rounded-3xl shadow-lg p-10 w-full max-w-md space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-[#3E36B0] text-white font-semibold py-2 rounded-lg shadow-md hover:bg-indigo-700 transition-all"
          >
            Login
          </button>
        </form>
