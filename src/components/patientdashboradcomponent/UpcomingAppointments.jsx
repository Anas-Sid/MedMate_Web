...
try {
  ...
  return (
    <div className="rounded-xl p-6 w-full max-w-md bg-gradient-to-br from-[#F0F3FF] to-[#B3C1EE] shadow-lg border border-gray-300 ml-[580px] -mt-[630px] h-[630px] flex flex-col">
      ...
      {/* Cancel All (not implemented yet) */}
      <div className="flex items-center justify-between bg-gradient-to-br from-[#FDB2B3] via-[#A54143] to-[#AF3D3F] text-white font-bold px-4 py-3 rounded-lg mb-4 shadow">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-end space-y-1">
                  ...
                  <button
                    className="text-white bg-[#AF3D3F] text-xs px-4 py-0.5 mt-0.5 rounded-lg shadow-sm hover:shadow-md active:translate-y-[1px] transition-all duration-150 hover:bg-red-600"
