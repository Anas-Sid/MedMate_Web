    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="space-x-2 hidden md:block">
          <RouterLink to="/login">
            <button className="px-9 py-1 border mr-5 border-blue-600 text-blue-600 rounded-lg font-medium transition-all hover:bg-blue-600 hover:text-white hover:scale-105 active:scale-95 shadow-md hover:shadow-lg">
              Login
            </button>
          </RouterLink>
          <RouterLink to="/signup">
            <button className="px-9 py-1 bg-blue-600 text-white rounded-lg font-medium transition-all hover:bg-blue-700 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg">
              Signup
            </button>
          </RouterLink>
        </div>
